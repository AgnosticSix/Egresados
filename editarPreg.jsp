    ...
    <div class="idealsteps-container">
      ...
      <form  action="insertar.jsp" method="post" class="idealforms" >
    	...
    	<input name="f" value="<%request.getParameter("idPregunta"); %>"></input>
    	  ...
    	  out.print("<input name='pre' value='"+re.getString("PREGUNTA")+"'></input>");
    	  out.print("</div>");
    	  out.print("<div class='field' >");
    	  out.print("<label class='main'>Tipo: "+re.getString("TIPO")+"</label>");
    	  out.print("<input name='tipo' value='"+re.getString("TIPO")+"'></input>");
    	  out.print("</div>");
    	  out.print("<div class='field' >");
    	  out.print("<label class='main'>Sección: "+re.getString("SECCION")+"</label>");
    	  out.print("<input name='sec' value='"+re.getString("SECCION")+"'></input>");
    	  out.print("</div>");
    	  out.print("<div class='field' >");
    	  out.print("<label class='main'>Área: "+re.getString("AREA")+"</label>");
    	  out.print("<input name='area' value='"+re.getString("AREA")+"'></input>");
    	  out.print("</div>");
    	  if(re.getString("TIPO")=="2"){
        	  rste = objCon.ejecSQL("SELECT * FROM CATOPCIONES WHERE CATPID="+request.getParameter("idPregunta"));
        	  
        	  while(rste.next()){
        		  out.print("<div class='field'>");
        	  		out.print("<label value='"+rste.getString("OPCION")+"'>Opcion "+i+" :"+rste.getString("OPCION")+"</label>");
        	  		out.print("<input name='opcion"+i+"' value='"+rste.getString("OPCION")+"'></input>");
              	  out.print("</div>");
        	  		i++;
        	  }
        	  out.print("<div class='field' id='blog-test-cont'>");
        	  out.print("<input type='button' value='Añadir Opción' class='blog-test'/>");
        	  out.print("</div>");
    	  }
  		%>
			 	...
			 	<script type="text/javascript">
			  	$(document).ready(function() {
			  		...
			  		$("#blog-test-cont .blog-test").bind("click", function(){
			  			...
			  			$(this).after("<input class=\"blog-test\"name=opcion"+(++bt_count)+"> " );
